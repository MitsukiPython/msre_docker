...
Furthermore, when simulating thorium/plutonium hybrids in the reactor salt, the code was further modified so that the "UF4" was a combination of thorium and plutonium fluoride salts.
